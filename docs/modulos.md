...
| Exercícios de Padrões | Opcional (flag `bibliotecas`) — ✅ | 5+ | 57 padrões próprios (preliminares, dominante, menor, II–V, II–V–I, II–V–i, V7alt, tercinas) nos 12 tons pelo ciclo de 4ªs, com fórmula em graus, partitura/tab/notas e áudio com acompanhamento; "padrão próprio" a partir de graus digitados. |

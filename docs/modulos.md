...
| Biblioteca de Fraseados | Opcional (flag `bibliotecas`) — ✅ | 5+ | Frases geradas para qualquer escala (26), em qualquer tom (ou nos 12), em 6 estilos (Bebop/Parker, Jazz moderno, Blues, Modal, Rock, Baião), com ritmo, partitura, tab, áudio e explicação; páginas infinitas. Livre; nível Avançado = Pro. |
